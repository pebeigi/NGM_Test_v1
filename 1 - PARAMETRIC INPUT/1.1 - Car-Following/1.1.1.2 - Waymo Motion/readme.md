...
| `March2023waymo_map_features_{196–199}_data.csv` | Per-scenario map geometry: lane polylines, road edges/lines, crosswalks, speed limits. Used for lane-centered longitudinal coordinates, visualization, and diagnostics. |
